...
resource "google_compute_attached_disk" "default" {
    ...
    instance = "${google_compute_disk.default.self_link}"
    # if google.compute.disk.default has count or for each set:
    # instance = "${google_compute_disk.default[0].self_link}"
}